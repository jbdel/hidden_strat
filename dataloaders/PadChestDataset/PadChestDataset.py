...
from .BasePadChest import BasePadChest
...
class PadChestDataset(BasePadChest):
    def __init__(self, split, return_image=False, return_label=False, return_report=False, **kwargs):
        ...
        self.transform = BasePadChest.get_transforms(split)
